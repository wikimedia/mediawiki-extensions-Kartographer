...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	removeHooks: function () {
		...
		// HACK: zoomlevelschange is never unbound in the upstream library,
		// but that causes problems (T188061), so unbind it anyway
	...
	addHooks: function () {
		...
		if (map) {
			...
			this._map
				...
				// LOCAL PATCH: comment out reference to nonexistent _editStyle method
