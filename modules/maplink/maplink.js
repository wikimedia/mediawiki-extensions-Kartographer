...
function handleMapLinks( $content ) {
	...
	// TODO remove the "data-mw="interface" selector once the HTML cache is expired
	$content.find( '.mw-kartographer-maplink[data-mw-kartographer], .mw-kartographer-maplink[data-mw="interface"]' )
		.each( function () {
